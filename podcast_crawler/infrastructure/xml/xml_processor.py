...
class XMLProcessor:
    ...
    def _extract_episode_from_item(self, item) -> Episode:
        ...
        url = enclosure.attrib['url'] if enclosure is not None and 'url' in enclosure.attrib else ''
        file_size = int(enclosure.attrib['length']) if enclosure is not None and 'length' in enclosure.attrib else None
